...
// Definimos a mensagem category com seus campos. Cada campo possui um tipo e um número único.
type Category struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Id            string                 `protobuf:"bytes,1,opt,name=id,proto3" json:"id,omitempty"`                   //Campo id do tipo string.
	Name          string                 `protobuf:"bytes,2,opt,name=name,proto3" json:"name,omitempty"`               //Campo name do tipo string.
	Description   string                 `protobuf:"bytes,3,opt,name=description,proto3" json:"description,omitempty"` //Campo description do tipo string.
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
// Definimos a nossa requisição de criação de categoria.
...
type CategoryList struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Categories    []*Category            `protobuf:"bytes,1,rep,name=categories,proto3" json:"categories,omitempty"` //Lista de categorias.
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
